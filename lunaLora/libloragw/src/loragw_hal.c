...
static lgw_context_t lgw_context = {
    ...
    .sx1261_cfg = {
        .enable = true,
        //.enable = false,
        //.spi_path = "/dev/spidev0.1", //010c
        //.spi_path = "/dev/spidev0.2",	  //090a
        .spi_path = "/dev/spidev32766.1",	  //210
        .rssi_offset = 0,
#if 0
        .lbt_conf = {
            .enable = true,
           .rssi_target = -80,
            .nb_channel = 1,
            .channels = {
              {.freq_hz = 923100000, .bandwidth = 0x04, .scan_time_us = 5000, .transmit_time_ms = 4000},
            }
        }
#else
        .lbt_conf = {{0}}
...
int lgw_start(void) {
    ...
    if (0 && CONTEXT_COM_TYPE == LGW_COM_SPI) {
